			...
			<main>
				<section className="relative bg-gray-200 py-20">
					...
					<div className="relative z-20 container mx-auto px-4 text-center">
						...
						<p className="mx-auto max-w-2xl text-lg text-white">
							A notícia que você está procurando não foi encontrada ou não está mais disponível.
						</p>
					</div>
				</section>
				...
				<div className="container mx-auto my-16 px-4 text-center">
					<div className="rounded-lg p-10">
						...
						<h2 className="mb-4 text-2xl font-bold">Notícia não encontrada</h2>
						<p className="mb-8 text-gray-600">
							A notícia que você está procurando pode ter sido removida, renomeada ou ainda não foi
							publicada.
						</p>
						<Link
							href="/noticias"
