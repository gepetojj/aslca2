				...
				<section className="relative bg-gray-200 py-20">
					...
					<div className="relative z-20 container mx-auto px-4 text-center">
						...
						<p className="mx-auto max-w-2xl text-lg text-white">
							A postagem que você está procurando não foi encontrada ou não está mais disponível.
						</p>
					</div>
				</section>
				...
				<div className="container mx-auto my-16 px-4 text-center">
					<div className="rounded-lg p-10">
						<div className="mx-auto mb-6 flex h-20 w-20 items-center justify-center rounded-full bg-amber-50">
							<IconNewSection className="h-10 w-10 text-amber-800" />
						</div>
						<h2 className="mb-4 text-2xl font-bold">Postagem não encontrada</h2>
						<p className="mb-8 text-gray-600">
							A postagem que você está procurando pode ter sido removida, renomeada ou ainda não foi
							publicada.
						</p>
						<Link
							href="/blog"
